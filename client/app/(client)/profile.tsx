...
export default function Profile() {
  ...
  const pickAvatar = async () => {
    try {
      ...
      showToast("Impossible d'ouvrir la galerie", "error");
    }
  };
    ...
    <View className="flex-1 bg-white">
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 32, marginTop: -120 }}>
        ...
        <TouchableOpacity
          onPress={pickAvatar}
          activeOpacity={0.9}
          className="self-center w-28 h-28 rounded-full bg-white/90 items-center justify-center border border-slate-200 shadow-sm"
        >
          {avatarUrl ? (
