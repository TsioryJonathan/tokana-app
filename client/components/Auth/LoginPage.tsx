...
export default function LoginPage({
  ...
  return (
    <View className="flex-1 px-6 bg-customwhite justify-center font-clash">
      ...
      <View className="items-center mb-6 -mt-10">
        <Text className="text-4xl font-clash  text-gray-900">Se connecter</Text>
      ...
      <View className="flex-row gap-3">
        <TouchableOpacity className="flex-1 border border-gray-300 rounded-lg py-3 items-center bg-white flex-row justify-center gap-2">
          <GoogleIcon size={20} />
          <Text className="font-quicksand-medium text-gray-700">Google</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-1 border border-gray-300 rounded-lg py-3 items-center bg-white flex-row justify-center gap-2">
          <FacebookIcon size={20} />
          <Text className="font-quicksand-medium text-gray-700">Facebook</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
