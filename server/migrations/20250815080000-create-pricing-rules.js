export default {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('PricingRules', {
      ...
      expressSurcharge: { type: Sequelize.INTEGER, allowNull: false, defaultValue: 0 },
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    if (queryInterface.sequelize.getDialect() === 'postgres') {
      await queryInterface.sequelize.query("DROP TYPE IF EXISTS \"enum_PricingRules_zoneLevel\";");
      await queryInterface.sequelize.query("DROP TYPE IF EXISTS \"enum_PricingRules_type\";");
    }
  },
};
