...
import settlementsAdminRoutes from "./routes/admin/settlementsAdminRoutes.js";
import dispatchesAdminRoutes from "./routes/admin/dispatchesAdminRoutes.js";
import reportsAdminRoutes from "./routes/admin/reportsAdminRoutes.js";
...
app.use("/api/admin/settlements", settlementsAdminRoutes);
app.use("/api/admin/dispatches", dispatchesAdminRoutes);
